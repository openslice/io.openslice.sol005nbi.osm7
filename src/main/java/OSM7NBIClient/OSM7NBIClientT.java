...
import OSM7NBIClient.NSInstantiateInstanceRequestPayload.NInterface;
import OSM7NBIClient.NSInstantiateInstanceRequestPayload.Vdu;
...
//		}
		...
		for(ConstituentVnfd constituenVnfd : constituentVnfds)
		{
			...
			else
			{
				...
				OSM7NBIClient.NSInstantiateInstanceRequestPayload.Vdu vdu_tmp = nscreateinstancerequestpayload.new Vdu();
				vdu_tmp.setId("cirros_vnfd-VM");
				OSM7NBIClient.NSInstantiateInstanceRequestPayload.NInterface interface_tmp = nscreateinstancerequestpayload.new NInterface();
		...
		{
			OSM7NBIClient.NSInstantiateInstanceRequestPayload.Vld vld_tmp = nscreateinstancerequestpayload.new Vld();  
...
//			vld_tmp.setIpProfile(ipprofileparams_tmp);
			...
			OSM7NBIClient.NSInstantiateInstanceRequestPayload.Vld vld_tmp2 = nscreateinstancerequestpayload.new Vld();  
		...
		if (ns_instance_creation_entity == null || ns_instance_creation_entity.getStatusCode().is4xxClientError()
			...
			{
				OSM7NBIClient.NSInstantiateInstanceRequestPayload.Vld vld_tmp = nsrequestpayload.new Vld();  
				vld_tmp.setName("cirros_3vnf_nsd_vld1");
...
//				vld_tmp.setIpProfile(ipprofileparams_tmp);
				...
				OSM7NBIClient.NSInstantiateInstanceRequestPayload.Vld vld_tmp2 = nsrequestpayload.new Vld();  
				vld_tmp2.setName("cirros_3vnf_nsd_vld2");
				//vld_tmp2.setVimNetworkName("OSM_mgmt_net");
				LinkedHashMap<String,String> tmp2=new LinkedHashMap<>();
				tmp2.put("4efd8bf4-5292-4634-87b7-7b3d49108b36","OSM_mgmt_net");
