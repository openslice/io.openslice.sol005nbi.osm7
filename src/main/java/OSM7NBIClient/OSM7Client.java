...
public class OSM7Client implements OSMClient{

	private static final Logger logger = LogManager.getLogger(OSM7Client.class);
	...
	public OSM7Client(String apiEndpoint, String username, String password, String project_id) throws HttpStatusCodeException 
	{
...
//	}
	...
	public String createNSInstance(String ns_name,String vim_id,String nsd_id)
	{
		...
		if (create_ns_instance_entity.getStatusCode() == HttpStatus.CREATED) {
			System.out.println("ÃŽï¿½S Instance Creation Succeded!");
		}
...
//	}	
	...
	public String terminateNSInstance(String ns_instance_id) {
		...
		if (terminate_ns_instance_entity.getStatusCode() == HttpStatus.CREATED) {
			System.out.println("ÃŽï¿½S Termination Succeded!");
		}
	...
	public ResponseEntity<String> deleteNSInstance(String ns_instance_id) {
		...
		if (delete_ns_instance_entity.getStatusCode() == HttpStatus.CREATED) {
			System.out.println("ÃŽï¿½S Deletion Succeded!");
		}
...
//		}
        ...
        OSM7Client.setManoAuthorizationTokenTimeout(obj.getDouble("expires"));
        OSM7Client.setManoAuthorizationTokenID(obj.getString("id"));
        try {
			httpClient.close();
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	private static String getManoAuthorizationTokenID() {
		...
		return OSM7Client.manoAuthorizationTokenID;
	}

	private static void setManoAuthorizationTokenID(String tokenID) {
		// TODO Auto-generated method stub
		OSM7Client.manoAuthorizationTokenID=tokenID;		
	}
	...
	public static void setManoAuthorizationTokenTimeout(double manoAuthorizationTokenTimeout) {
		OSM7Client.manoAuthorizationTokenTimeout = manoAuthorizationTokenTimeout;
	}	
}
